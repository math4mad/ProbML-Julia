...
leftPanel=(gl,Ytr,selectedYtr)->let
    ...
    scatter!(ax, selectedYtr.x1,selectedYtr.x2,color=:red,marker=:cross,markersize=16)
    scatter!(ax, Ytr.x1,Ytr.x2,color=(:lightgreen,0.2))
...
function plot_pca(num)
    ...
    rightPanel(gr,imgs)
    #save("./ch20/imgs/2pcs-reconstruct/mnist-digits=$(num)-pca-2pcs.png",fig)
end
